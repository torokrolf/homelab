...
- **DNS override:** a homelab hálózaton belül a `*.trkrolf.com` kéréseket a lokális DNS IP-címére irányítom, így nem a publikus DNS szerver oldja fel, és internet nélküli is működik.

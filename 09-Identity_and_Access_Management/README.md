...
- **Session Lifetime:** Extended the default Authentik SSO session validity from 1 day to 7 days. This ensures that the browser retains the authenticated state for a full week, eliminating daily re-authentication, while Passkey protection guarantees security when starting new sessions.

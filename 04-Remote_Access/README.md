...
This is a **full tunnel** configuration. Setting AllowedIPs = 0.0.0.0/0 means that all client traffic is routed through the VPN, not just traffic destined for my homelab. I also configured the DNS server to use a DNS server located in my homelab, so in addition to the full tunnel, this is also a **full DNS tunnel**.

<img width="318" height="685" alt="kép" src="https://github.com/user-attachments/assets/c9239a07-9f68-402c-be31-e332b9401e0f" />

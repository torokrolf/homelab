...
**Full tunnel** konfiguráció, az AllowedIPs = 0.0.0.0/0 beállítás azt jelenti, hogy a kliens összes forgalma a VPN-en keresztül megy, nem csak a homelab felé irányuló, DNS szervernél pedig megadtam a homelabomban lévő DNS szervert, így a full tunnel melllett **full DNS tunnel** is van.
